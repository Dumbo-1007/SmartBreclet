/**
  ...
  *                                  timr or configure other parameters.
  *                                     
...
/**
  ...
  *         be used by the user application to setup the SysTick timr or configure
  *         other parameters.
  *           
  * @note   Each tim the core clock (HCLK) changes, this function must be called
